			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" method="post" action="addroute.php">
					<div class="wrap-input100 validate-input m-b-26" data-validate="rid is required">
						...
						<input class="input100" type="text" name="rid" placeholder="Enter route number (ex:R12)">
					...
					<div class="wrap-input100 validate-input m-b-26" data-validate="route name is required">
						...
						<input class="input100" type="time" name="depart_time" placeholder="Enter departure time">
						<span class="focus-input100"></span>
					</div>
                    <div class="wrap-input100 validate-input m-b-26" data-validate="employee address is required">
						...
						<input class="input100" type="time" name="arr_time" placeholder="Enter arrival time">
						<span class="focus-input100"></span>
					</div>
                    <div class="wrap-input100 validate-input m-b-26" data-validate="age is required">
						<span class="label-input100">distance</span>
						<input class="input100" type="text" name="distance" placeholder="Enter distance">
						<span class="focus-input100"></span>
					</div>
...
if(isset($_POST['add']))
{
	...
	$qry=mysqli_query($con,"INSERT INTO `route`(`rid`, `depart_time`, `arr_time`, `distance`, `origin`, `destination`, `fare`) VALUES ('$rid','$depart_time','$arr_time','$distance','$origin','$destination','$fare')")or die(mysqli_error($con));
	if($qry==true)
		{
			echo "
			<script>
